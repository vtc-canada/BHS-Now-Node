...
var chatboxManager = function() {
    ...
    var config = {
        ...
        gap : 20,
        maxBoxes : 5,
        loadearliertext:null,
        messageSent : function(dest, msg,messageID) {
            // override this
            $("#" + dest).chatbox("option", "boxManager").addMsg(dest, msg,messageID);
        }
    };
    ...
    var getOpenBoxes=function(){
        return showList;
    }


    var delBox = function(id) {
        var index = boxList.indexOf(id);
    ...
    var addBox = function(id, user, name) {
        ...
        if(idx1 != -1) {
            ...
            $(el).chatbox({id : id,
                   ...
                   loadearliertext : config.loadearliertext,
                   hidden : false,
                   width : config.width,
	...
	$("#" + id).chatbox("option", "boxManager").addMsg(user.first_name, msg,messageID);
    }
