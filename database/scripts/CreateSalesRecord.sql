...
CREATE PROCEDURE `CreateSalesRecord`(IN salePrice FLOAT,IN saleDate DATETIME, IN heatSystemAge INT, IN windowsInstalledYear INT, 
		IN elevatorInstalledYear INT, IN has_elevator BOOLEAN, IN boilerInstalledYear INT, IN cableInternetProvider VARCHAR(45), IN assessedValue FLOAT, 
...
,OUT id INT)
BEGIN
	INSERT INTO cur_sales_record_history(sale_price,sale_date,heat_system_age,windows_installed_year,elevator_installed_year,has_elevator,boiler_installed_year
		,cable_internet_provider,assessed_value,heat_system_type,unit_quantity
...
,cap_rate,building_type,last_boiler_upgrade_year,mortgage_company,mortgage_due_date) 
		VALUES (salePrice, saleDate, heatSystemAge, windowsInstalledYear, elevatorInstalledYear,has_elevator, boilerInstalledYear, cableInternetProvider
