...
IF (searchTerms IS NULL) THEN
	...
	WHERE 
		(unitQuantityMax IS NULL OR unit_quantity <= unitQuantityMax)
		AND (unitQuantityMin IS NULL OR unit_quantity >= unitQuantityMin)
...
IF (searchTerms IS NOT NULL) THEN
