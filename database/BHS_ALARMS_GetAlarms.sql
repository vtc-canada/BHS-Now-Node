...
BEGIN
	...
	INNER JOIN ref_color_def AS ref_main_color_def ON ref_color_def.id = ref_status_def.color_ID
	INNER JOIN ref_color_def AS ref_text_color_def ON ref_color_def.id = ref_status_def.text_color_ID
