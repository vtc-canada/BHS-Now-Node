...
module.exports = {
	...
	sails.controllers.database.credSproc('SearchNotes', [ note_search, req.body.user == '' ? null : req.body.user,
		...
		(req.body.saleDateRangeEnd == '' || req.body.saleDateRangeEnd == null) ? null : toUTCDateTimeString(req.body.saleDateRangeEnd), req.body.start,
		999999, orderstring, filteredCount, totalCount ], function(err, responseNotes) {
	    if (err) {
		return res.json({
