...
module.exports = {
	...
	Database.dataSproc('FMS_MANIFEST_GetManifestByLegId',[req.body.leg_ID],function(err,response){
		...
		Database.dataSproc('FMS_MANIFEST_CreateManifestDetail',[response[0][0].id, req.body.contact_ID, req.body.pax_weight, manifestDetailsId],function(err,manifestdetail){
		    if(err){
